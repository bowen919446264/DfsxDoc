...
import com.dfsx.lzcms.liveroom.view.slidemenu.utils.ScrollDetectors;
import com.dfsx.lzcms.liveroom.view.slidemenu.utils.ScrollDetectors.ScrollDetector;
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (Math.abs(dx) >= mTouchSlop /*&& (mIsTapInContent || isSupportPrimaryMenuTouchControl())*/) {
