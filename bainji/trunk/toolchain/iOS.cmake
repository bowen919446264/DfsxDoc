...
#    message (FATAL_ERROR "Unsupported IOS_PLATFORM: ${IOS_PLATFORM} selected. Please choose OS or SIMULATOR")
...
set (IOS_ARCH ${IOS_ARCH} CACHE STRING "Type of iOS Architecture")
...
elseif (${IOS_ARCH} STREQUAL "x86_64")
    ...
    set (IOS_PLATFORM_LOCATION "iPhoneSimulator.platform")
    set (CMAKE_XCODE_EFFECTIVE_PLATFORMS "-iphonesimulator")
else (${IOS_ARCH} STREQUAL "armv7")
    message (FATAL_ERROR "Unkonwn arch: ${IOS_ARCH}")
endif (${IOS_ARCH} STREQUAL "armv7")
