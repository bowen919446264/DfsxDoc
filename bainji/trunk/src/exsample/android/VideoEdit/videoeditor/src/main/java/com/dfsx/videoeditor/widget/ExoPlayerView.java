...
//                    Surface surface = ((EPlayerView) surfaceView).getPreviewSurface();
//                    if (surface != null) {
//                        oldVideoComponent.clearVideoSurface(surface);
//                    }
...
//                    } else {
//                        ((EPlayerView) surfaceView).setSimpleExoPlayer((SimpleExoPlayer) player);
//                    }
//                } else if (surfaceView instanceof SurfaceView) {
...
//     * this sourceDuration of time has elapsed without user input and with playback or buffering in
//     * progress.
//     *
...
//     * sourceDuration of time has elapsed without user input and with playback or buffering in progress.
//     *
