...
/**
 * Created by heyang on 2016/10/18.
 */
...
//        mBackgroundColor = a.getColor(R.styleable.ProgressButton_progressbtn_backgroud_color, Color.parseColor("#ffd02a4b"));
        mBackgroundColor = a.getColor(R.styleable.ProgressButton_progressbtn_backgroud_color, Color.parseColor("#ff54acee"));
//        mBackgroundColor = a.getColor(R.styleable.ProgressButton_progressbtn_backgroud_color, Color.WHITE);
        mBackgroundSecondColor = a.getColor(R.styleable.ProgressButton_progressbtn_backgroud_second_color, Color.WHITE);
        mButtonRadius = a.getFloat(R.styleable.ProgressButton_progressbtn_radius, getMeasuredHeight() / 10);
    ...
    public void setState(int state) {
        if (mState != state) {//状态确实有改变
            this.mState = state;
            invalidate();
            if (state == ProgressView.INSTALLING) {
                //开启两个点动画
