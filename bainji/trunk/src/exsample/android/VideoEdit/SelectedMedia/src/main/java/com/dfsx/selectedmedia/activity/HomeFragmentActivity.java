...
public class HomeFragmentActivity extends BaseActivity implements ImageFragment.OnImageSelectedListener,
				...
				if(videoFragment != null || imageFragment != null){
					...
					if(videoFragment != null){
						if(videoFragment.getSelectedVideoList() != null && videoFragment.getSelectedVideoList() .size() > 0){
							...
							videoIntent.putParcelableArrayListExtra("list", videoFragment.getSelectedVideoList());
